...
import logo from "../../assets/add-item.svg"
...
function Header() {
        ...
        useEffect(()=>{
            ...
            const identify = history.location.pathname.slice(8)
            setPath(identify)
            
            if(path == "couponTable"){
                setPlaceholder("serach a coupon")
            }
            if(path == "employee"){
    ...
    return (        
        <div className="Headercontainer">              
            <div className="header-content">
                    <div className="box">
                        <input type="text" placeholder={placeholder} onChange={(e)=>setFilterarray(e.target.value)}/>
                    ...
                    {/* <select className="dropdown">
                        ...
                        <div className="addbutton" onClick={callfun} >
